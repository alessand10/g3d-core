...
#include "components/world-transform-component.h"
#include "glm/ext.hpp"

void scSetCamera(G3DCameraComponent *camera, G3DWorldTransformComponent *transform, glm::mat4* view, glm::mat4* proj)
{
